...
QMV v1.2 - File details update - size, resolution, framerate, duration. Expected breakage to QMV JSON code. Sponsored by not having portable file browser that reads video duration.
